...
class RiderResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'current_location_accuracy' => $this->current_location_accuracy,
            'current_location_heading' => $this->current_location_heading,
            'current_location_speed' => $this->current_location_speed,
